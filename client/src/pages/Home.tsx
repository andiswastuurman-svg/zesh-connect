  ...
  return <div className="app-shell">
    ...
    <main className="main-canvas">
      ...
      <div className="content-wrap">
        ...
        {activeView === "Discover creators" && <CreatorDirectory filteredCreators={filteredCreators} search={search} setSearch={setSearch} niche={niche} setNiche={setNiche} saved={saved} setSaved={setSaved} notify={notify} onView={setSelectedCreator} />}
...
function CreatorDirectory({ filteredCreators, search, setSearch, niche, setNiche, saved, setSaved, notify, onView }: { filteredCreators: Creator[]; search: string; setSearch: (x: string) => void; niche: string; setNiche: (x: string) => void; saved: string[]; setSaved: (x: string[]) => void; notify: (x: string) => void; onView: (creator: Creator) => void }) {
